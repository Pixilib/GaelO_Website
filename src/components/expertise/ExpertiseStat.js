        ...
        <Fragment>
            ...
            <Col>
                <Row className={numberClass}>
                    <CountUp delay={1} redraw={true} className="textChiffre" end={t('expertise.trials.value')} duration="2" />
                </Row>
                <Row className={textClass}>
            ...
            <Col>
                <Row className={numberClass}>
                    <CountUp delay={1} redraw={true}  end={t('expertise.dicom.value')} duration="2" />
                </Row>
                <Row className={textClass}>
            ...
            <Col>
                <Row className={numberClass} >
                    <CountUp delay={1} redraw={true} end={t('expertise.center.value')} duration="2" />
                </Row>
                <Row className={textClass} >
            ...
            <Col>
                <Row className={numberClass}>
                    <CountUp delay={1} redraw={true} end={t('expertise.user.value')} duration="2" />
                </Row>
                <Row className={textClass}>
