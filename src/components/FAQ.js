                ...
                <Row className="text-start">
                    ...
                    <Col md={4}>
                        <Card border="dark">
                            ...
                            <Card.Body>
                                <Card.Text>
                                    <span className="ps-4"></span>{t('faq.answer.4')}
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={4}>
                        <Card border="dark">
                            <Card.Header>{t('faq.question.5')}</Card.Header>
                            <Card.Body>
                                <Card.Text>
                                    <ul>
                                        <li><span className="ps-4"></span>{t('faq.answer.5.0')}</li>
                                        <li>- {t('faq.answer.5.1')}</li>
                                        <li>- {t('faq.answer.5.2')}</li>
                                        <li>- {t('faq.answer.5.3')}</li>
                                        <li>- {t('faq.answer.5.4')}</li>
                                        <li>- {t('faq.answer.5.5')}</li>
                                        <li>- {t('faq.answer.5.6')}</li>
                                    </ul>
                                </Card.Text>
                            </Card.Body>
                        </Card>
